                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_EXAMPLE01, szWindowClass, MAX_LOADSTRING);
	...
	hdc = GetDC(hWnd);
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_EXAMPLE01));
...
ATOM MyRegisterClass(HINSTANCE hInstance) {
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_EXAMPLE01));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground  = (HBRUSH)GetStockObject(BLACK_BRUSH);
	wcex.lpszMenuName = MAKEINTRESOURCE(IDC_EXAMPLE01);

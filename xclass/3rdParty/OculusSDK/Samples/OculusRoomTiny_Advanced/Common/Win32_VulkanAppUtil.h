...
public:
    ...
    _(vkGetMemoryWin32HandlePropertiesKHX)
    ...
    {
        VkPhysicalDeviceIDPropertiesKHX gpuDevID{ VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHX };
    ...
    bool InitDevice(const char* appName, int vpW, int vpH, ovrSession session, const ovrGraphicsLuid& luid, bool windowed = true)
    {
        ...
        static const char* instExtensions[] =
        {
        ...
        #endif // defined(OVR_BUILD_DEBUG)
        instInfo.enabledExtensionCount = countof(instExtensions);
        ...
        if (isAMD)
        {
            deviceInfo.enabledExtensionCount = countof(deviceExtensionsAMD);
            deviceInfo.ppEnabledExtensionNames = deviceExtensionsAMD;
        }
        else
        {

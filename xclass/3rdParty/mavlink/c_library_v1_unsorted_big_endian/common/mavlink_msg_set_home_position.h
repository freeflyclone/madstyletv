...
#define MAVLINK_MSG_ID_SET_HOME_POSITION_CRC 149
#define MAVLINK_MSG_ID_243_CRC 149
...
#define MAVLINK_MESSAGE_INFO_SET_HOME_POSITION { \
    ...
    "SET_HOME_POSITION", \
    11, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_set_home_position_t, target_system) }, \
         { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 1, offsetof(mavlink_set_home_position_t, latitude) }, \
         { "longitude", NULL, MAVLINK_TYPE_INT32_T, 0, 5, offsetof(mavlink_set_home_position_t, longitude) }, \
         { "altitude", NULL, MAVLINK_TYPE_INT32_T, 0, 9, offsetof(mavlink_set_home_position_t, altitude) }, \
         { "x", NULL, MAVLINK_TYPE_FLOAT, 0, 13, offsetof(mavlink_set_home_position_t, x) }, \
         { "y", NULL, MAVLINK_TYPE_FLOAT, 0, 17, offsetof(mavlink_set_home_position_t, y) }, \
         { "z", NULL, MAVLINK_TYPE_FLOAT, 0, 21, offsetof(mavlink_set_home_position_t, z) }, \
         { "q", NULL, MAVLINK_TYPE_FLOAT, 4, 25, offsetof(mavlink_set_home_position_t, q) }, \
         { "approach_x", NULL, MAVLINK_TYPE_FLOAT, 0, 41, offsetof(mavlink_set_home_position_t, approach_x) }, \
         { "approach_y", NULL, MAVLINK_TYPE_FLOAT, 0, 45, offsetof(mavlink_set_home_position_t, approach_y) }, \
         { "approach_z", NULL, MAVLINK_TYPE_FLOAT, 0, 49, offsetof(mavlink_set_home_position_t, approach_z) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_HOME_POSITION { \
                               ...
                               uint8_t target_system, int32_t latitude, int32_t longitude, int32_t altitude, float x, float y, float z, const float *q, float approach_x, float approach_y, float approach_z)
{
    ...
    _mav_put_float(buf, 13, x);
    _mav_put_float(buf, 17, y);
    _mav_put_float(buf, 21, z);
    _mav_put_float(buf, 41, approach_x);
    _mav_put_float(buf, 45, approach_y);
    _mav_put_float(buf, 49, approach_z);
    _mav_put_float_array(buf, 25, q, 4);
...
{
    return _MAV_RETURN_float_array(msg, q, 4,  25);
}

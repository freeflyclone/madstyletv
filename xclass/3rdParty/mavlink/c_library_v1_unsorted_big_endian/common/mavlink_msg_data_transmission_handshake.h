...
#define MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_CRC 163
#define MAVLINK_MSG_ID_130_CRC 163
...
#define MAVLINK_MESSAGE_INFO_DATA_TRANSMISSION_HANDSHAKE { \
    ...
    {  { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_data_transmission_handshake_t, type) }, \
         ...
         { "width", NULL, MAVLINK_TYPE_UINT16_T, 0, 5, offsetof(mavlink_data_transmission_handshake_t, width) }, \
         { "height", NULL, MAVLINK_TYPE_UINT16_T, 0, 7, offsetof(mavlink_data_transmission_handshake_t, height) }, \
         { "packets", NULL, MAVLINK_TYPE_UINT16_T, 0, 9, offsetof(mavlink_data_transmission_handshake_t, packets) }, \
                               ...
                               uint8_t type, uint32_t size, uint16_t width, uint16_t height, uint16_t packets, uint8_t payload, uint8_t jpg_quality)
{
    ...
    _mav_put_uint16_t(buf, 5, width);
    _mav_put_uint16_t(buf, 7, height);
    _mav_put_uint16_t(buf, 9, packets);

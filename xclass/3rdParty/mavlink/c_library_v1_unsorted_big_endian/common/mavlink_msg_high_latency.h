...
#define MAVLINK_MSG_ID_HIGH_LATENCY_CRC 160
#define MAVLINK_MSG_ID_234_CRC 160
...
#define MAVLINK_MESSAGE_INFO_HIGH_LATENCY { \
    ...
    "HIGH_LATENCY", \
    24, \
    {  { "base_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_high_latency_t, base_mode) }, \
         { "custom_mode", NULL, MAVLINK_TYPE_UINT32_T, 0, 1, offsetof(mavlink_high_latency_t, custom_mode) }, \
         { "landed_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_high_latency_t, landed_state) }, \
         { "roll", NULL, MAVLINK_TYPE_INT16_T, 0, 6, offsetof(mavlink_high_latency_t, roll) }, \
         { "pitch", NULL, MAVLINK_TYPE_INT16_T, 0, 8, offsetof(mavlink_high_latency_t, pitch) }, \
         { "heading", NULL, MAVLINK_TYPE_UINT16_T, 0, 10, offsetof(mavlink_high_latency_t, heading) }, \
         { "throttle", NULL, MAVLINK_TYPE_INT8_T, 0, 12, offsetof(mavlink_high_latency_t, throttle) }, \
         { "heading_sp", NULL, MAVLINK_TYPE_INT16_T, 0, 13, offsetof(mavlink_high_latency_t, heading_sp) }, \
         { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 15, offsetof(mavlink_high_latency_t, latitude) }, \
         { "longitude", NULL, MAVLINK_TYPE_INT32_T, 0, 19, offsetof(mavlink_high_latency_t, longitude) }, \
         { "altitude_amsl", NULL, MAVLINK_TYPE_INT16_T, 0, 23, offsetof(mavlink_high_latency_t, altitude_amsl) }, \
         { "altitude_sp", NULL, MAVLINK_TYPE_INT16_T, 0, 25, offsetof(mavlink_high_latency_t, altitude_sp) }, \
         { "airspeed", NULL, MAVLINK_TYPE_UINT8_T, 0, 27, offsetof(mavlink_high_latency_t, airspeed) }, \
         { "airspeed_sp", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_high_latency_t, airspeed_sp) }, \
         { "groundspeed", NULL, MAVLINK_TYPE_UINT8_T, 0, 29, offsetof(mavlink_high_latency_t, groundspeed) }, \
         { "climb_rate", NULL, MAVLINK_TYPE_INT8_T, 0, 30, offsetof(mavlink_high_latency_t, climb_rate) }, \
         { "gps_nsat", NULL, MAVLINK_TYPE_UINT8_T, 0, 31, offsetof(mavlink_high_latency_t, gps_nsat) }, \
         { "gps_fix_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_high_latency_t, gps_fix_type) }, \
         { "battery_remaining", NULL, MAVLINK_TYPE_UINT8_T, 0, 33, offsetof(mavlink_high_latency_t, battery_remaining) }, \
         { "temperature", NULL, MAVLINK_TYPE_INT8_T, 0, 34, offsetof(mavlink_high_latency_t, temperature) }, \
         { "temperature_air", NULL, MAVLINK_TYPE_INT8_T, 0, 35, offsetof(mavlink_high_latency_t, temperature_air) }, \
         { "failsafe", NULL, MAVLINK_TYPE_UINT8_T, 0, 36, offsetof(mavlink_high_latency_t, failsafe) }, \
         { "wp_num", NULL, MAVLINK_TYPE_UINT8_T, 0, 37, offsetof(mavlink_high_latency_t, wp_num) }, \
                               ...
                               uint8_t base_mode, uint32_t custom_mode, uint8_t landed_state, int16_t roll, int16_t pitch, uint16_t heading, int8_t throttle, int16_t heading_sp, int32_t latitude, int32_t longitude, int16_t altitude_amsl, int16_t altitude_sp, uint8_t airspeed, uint8_t airspeed_sp, uint8_t groundspeed, int8_t climb_rate, uint8_t gps_nsat, uint8_t gps_fix_type, uint8_t battery_remaining, int8_t temperature, int8_t temperature_air, uint8_t failsafe, uint8_t wp_num, uint16_t wp_distance)
{
    ...
    _mav_put_uint8_t(buf, 0, base_mode);
    _mav_put_uint32_t(buf, 1, custom_mode);
    _mav_put_uint8_t(buf, 5, landed_state);
    _mav_put_int16_t(buf, 6, roll);
    _mav_put_int16_t(buf, 8, pitch);
    _mav_put_uint16_t(buf, 10, heading);
    _mav_put_int8_t(buf, 12, throttle);
    _mav_put_int16_t(buf, 13, heading_sp);
    _mav_put_int32_t(buf, 15, latitude);
    _mav_put_int32_t(buf, 19, longitude);
    _mav_put_int16_t(buf, 23, altitude_amsl);
    _mav_put_int16_t(buf, 25, altitude_sp);
    _mav_put_uint8_t(buf, 27, airspeed);
    _mav_put_uint8_t(buf, 28, airspeed_sp);
    _mav_put_uint8_t(buf, 29, groundspeed);
    _mav_put_int8_t(buf, 30, climb_rate);
    _mav_put_uint8_t(buf, 31, gps_nsat);
    _mav_put_uint8_t(buf, 32, gps_fix_type);
    _mav_put_uint8_t(buf, 33, battery_remaining);
    _mav_put_int8_t(buf, 34, temperature);
    _mav_put_int8_t(buf, 35, temperature_air);
    _mav_put_uint8_t(buf, 36, failsafe);
    _mav_put_uint8_t(buf, 37, wp_num);

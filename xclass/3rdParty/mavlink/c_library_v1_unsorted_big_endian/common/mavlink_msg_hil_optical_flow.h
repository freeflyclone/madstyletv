...
#define MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_CRC 207
#define MAVLINK_MSG_ID_114_CRC 207
...
#define MAVLINK_MESSAGE_INFO_HIL_OPTICAL_FLOW { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_optical_flow_t, time_usec) }, \
         ...
         { "integration_time_us", NULL, MAVLINK_TYPE_UINT32_T, 0, 9, offsetof(mavlink_hil_optical_flow_t, integration_time_us) }, \
         { "integrated_x", NULL, MAVLINK_TYPE_FLOAT, 0, 13, offsetof(mavlink_hil_optical_flow_t, integrated_x) }, \
         { "integrated_y", NULL, MAVLINK_TYPE_FLOAT, 0, 17, offsetof(mavlink_hil_optical_flow_t, integrated_y) }, \
         { "integrated_xgyro", NULL, MAVLINK_TYPE_FLOAT, 0, 21, offsetof(mavlink_hil_optical_flow_t, integrated_xgyro) }, \
         { "integrated_ygyro", NULL, MAVLINK_TYPE_FLOAT, 0, 25, offsetof(mavlink_hil_optical_flow_t, integrated_ygyro) }, \
         { "integrated_zgyro", NULL, MAVLINK_TYPE_FLOAT, 0, 29, offsetof(mavlink_hil_optical_flow_t, integrated_zgyro) }, \
         { "temperature", NULL, MAVLINK_TYPE_INT16_T, 0, 33, offsetof(mavlink_hil_optical_flow_t, temperature) }, \
         { "quality", NULL, MAVLINK_TYPE_UINT8_T, 0, 35, offsetof(mavlink_hil_optical_flow_t, quality) }, \
         { "time_delta_distance_us", NULL, MAVLINK_TYPE_UINT32_T, 0, 36, offsetof(mavlink_hil_optical_flow_t, time_delta_distance_us) }, \
         { "distance", NULL, MAVLINK_TYPE_FLOAT, 0, 40, offsetof(mavlink_hil_optical_flow_t, distance) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_OPTICAL_FLOW { \

...
#define MAVLINK_MSG_ID_ATTITUDE_TARGET_CRC 143
#define MAVLINK_MSG_ID_83_CRC 143
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE_TARGET { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_attitude_target_t, time_boot_ms) }, \
         { "type_mask", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_attitude_target_t, type_mask) }, \
         { "q", NULL, MAVLINK_TYPE_FLOAT, 4, 5, offsetof(mavlink_attitude_target_t, q) }, \
         { "body_roll_rate", NULL, MAVLINK_TYPE_FLOAT, 0, 21, offsetof(mavlink_attitude_target_t, body_roll_rate) }, \
         { "body_pitch_rate", NULL, MAVLINK_TYPE_FLOAT, 0, 25, offsetof(mavlink_attitude_target_t, body_pitch_rate) }, \
         { "body_yaw_rate", NULL, MAVLINK_TYPE_FLOAT, 0, 29, offsetof(mavlink_attitude_target_t, body_yaw_rate) }, \
         { "thrust", NULL, MAVLINK_TYPE_FLOAT, 0, 33, offsetof(mavlink_attitude_target_t, thrust) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ATTITUDE_TARGET { \
                               ...
                               uint32_t time_boot_ms, uint8_t type_mask, const float *q, float body_roll_rate, float body_pitch_rate, float body_yaw_rate, float thrust)
{
    ...
    _mav_put_uint8_t(buf, 4, type_mask);
    _mav_put_float(buf, 21, body_roll_rate);
    _mav_put_float(buf, 25, body_pitch_rate);
    _mav_put_float(buf, 29, body_yaw_rate);
    _mav_put_float(buf, 33, thrust);
    _mav_put_float_array(buf, 5, q, 4);

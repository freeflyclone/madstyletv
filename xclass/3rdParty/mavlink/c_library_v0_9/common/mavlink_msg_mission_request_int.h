...
#define MAVLINK_MSG_ID_MISSION_REQUEST_INT_CRC 254
#define MAVLINK_MSG_ID_51_CRC 254
...
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_INT { \
    ...
    "MISSION_REQUEST_INT", \
    3, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mission_request_int_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_mission_request_int_t, target_component) }, \
         { "seq", NULL, MAVLINK_TYPE_UINT16_T, 0, 2, offsetof(mavlink_mission_request_int_t, seq) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_INT { \
